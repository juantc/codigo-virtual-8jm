 ...
 */
var edades = [35, 45, 68, 80, 74, 20, 15, 95, 65, 45];
console.log(edades);
/********
...
console.log("Elementos del arreglo: ".concat(edades.length));
console.log("Primer elemento de un arreglo: ".concat(edades[0]));
console.log("\xDAltimo elemento de un arreglo: ".concat(edades[edades.length - 1]));

for (var i = 0; i < edades.length; i++) {
  console.log(edades[i]);
}

for (var _i = 0; _i < edades.length; _i++) {
  //Por ejemplo, sólo se pueden vacunar las personas que tengan
  //una edad mayor o igual a 60 añitos
  //
  if (edades[_i] >= 60) {
    console.log("Apto con edad de: ".concat(edades[_i], " a\xF1os"));
  }
}