...
/**
 * Funcion que imprime los nombres de todas las peliculas
 */

const imprimirNombres=()=>{
    /*****
     * 1. recorro el arreglo (for)
     * 2. en cada iteración hago un console.log del nombre de la pelicula
     */
 ...
 * @param {*} fecha 
 */
const imprimirPeliculaPorFechaLanzamiento=(fecha)=>{

}

/**
 * Funcion que imprime las peliculas con mayor cantidad de género
 */
